   ...
   return (
      <Container>
         <div className="flex flex-col md:flex-row gap-5">
            <Image height={0} width={400} priority={true} src={`http://image.tmdb.org/t/p/w500${movie.poster_path}`} alt={movie.title} className="aspect-[1/1] object-contain w-full md:w-[400px]" />
